      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-gray-900 mb-2">Elector-Only</h4>
            <p className="text-gray-600">
              Only verified electors can participate. Identity is verified via email or SMS to ensure election integrity.
            </p>
          </div>
        </div>
      </main>
